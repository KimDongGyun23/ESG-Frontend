...
function Quiz() {
  ...
  const quiz = {
    list: [
      ...
      {
        id: 1,
        question: "ESG는 1994년 UN글로벌컴팩트에서 처음 언급되었다.",
        options: ["O", "X"],
        answer: "O",
      },
      {
        id: 2,
        question: "ESG는 기업 경영을 평가하는 재무적 성과 측정지표이다.",
        options: ["O", "X"],
        answer: "X",
      },
      {
        id: 3,
        question: "한국은 2020년부터 기업에게 ESG 정보 공개 의무를 부여했다.",
        options: ["O", "X"],
        answer: "X",
      },
      {
        id: 4,
        question: "2030년부터 코스피 상장사는 ESG 보고서 발간을 의무화 하였다.",
        options: ["O", "X"],
        answer: "X",
      },
      {
        id: 5,
        question: "한국에서 기업 ESG 등급은 한국ESG기준원이 평가한다.",
        options: ["O", "X"],
        answer: "O",
      },
    ],
